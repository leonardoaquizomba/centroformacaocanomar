...
class CertificatePolicy
{
    ...
    /**
     * Admins can download any certificate; students can only download their own.
     */
    public function download(AuthUser $authUser, Certificate $certificate): bool
    {
        return $authUser->hasRole('admin') || $authUser->id === $certificate->user_id;
    }
}
