...
<head>
    ...
    <title>Inscrição Rejeitada</title>
    <style>
        ...
        .badge { display: inline-block; background: #ef4444; color: #ffffff; border-radius: 20px; padding: 4px 16px; font-size: 13px; margin-top: 10px; }
        ...
        .reason-box { background: #fff5f5; border: 1px solid #fecaca; border-radius: 6px; padding: 16px 20px; margin: 20px 0; }
        .reason-box h3 { color: #ef4444; margin-top: 0; font-size: 15px; }
...
<body>
    <div class="wrapper">
        <div class="header">
            ...
            <div class="badge">Inscrição Rejeitada</div>
        </div>
        <div class="body">
            <h2>A sua inscrição não foi aprovada</h2>
            <p>Olá, <strong>{{ $enrollment->user->name }}</strong>,</p>
            <p>
                Lamentamos informar que a sua inscrição não pôde ser aprovada neste momento.
            </p>
            <div class="info-box">
            ...
            @endif
            <p>
                Se tiver alguma dúvida ou desejar mais informações, não hesite em contactar-nos.
                Poderá também submeter uma nova inscrição após resolver os pontos indicados.
            </p>
            <a href="{{ config('app.url') }}/contactos" class="btn">Contactar-nos</a>
        </div>
        <div class="footer">
