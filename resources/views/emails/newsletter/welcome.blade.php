...
<head>
    ...
    <title>Subscrição Confirmada</title>
    <style>
...
<body>
    <div class="wrapper">
        ...
        <div class="body">
            ...
            @endif
            <p>
                A sua subscrição à newsletter do Centro de Formação Canomar foi confirmada com sucesso.
                Irá receber as nossas novidades, cursos e eventos directamente no seu email.
            </p>
            <a href="{{ config('app.url') }}/cursos" class="btn">Ver Cursos Disponíveis</a>
        </div>
        <div class="footer">
            <p>© {{ date('Y') }} Centro de Formação Canomar. Todos os direitos reservados.</p>
            <p>
                Não pretende receber mais emails?
