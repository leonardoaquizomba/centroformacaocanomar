...
<head>
    ...
    <style>
        ...
        .badge { display: inline-block; background: #3b82f6; color: #ffffff; border-radius: 20px; padding: 4px 16px; font-size: 13px; margin-top: 10px; }
...
<body>
    <div class="wrapper">
        <div class="header">
            ...
            <div class="badge">Nova Inscrição</div>
        </div>
        <div class="body">
            <h2>Nova inscrição recebida</h2>
            <p>Uma nova inscrição foi submetida e aguarda revisão.</p>
            <div class="info-box">
                ...
                @endif
                <p><strong>Data de inscrição:</strong> {{ $enrollment->created_at->format('d/m/Y \à\s H:i') }}</p>
            </div>
            <a href="{{ config('app.url') }}/admin/enrollments" class="btn">Ver no Painel Admin</a>
        </div>
        <div class="footer">
